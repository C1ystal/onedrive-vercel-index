...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'chargecrystal@stonty.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/ChargeCrystal',
    },
    {
      name: 'biibili',
      link: 'https://space.bilibili.com/164514784',
    },
  ],
